...
# server set up.
c.CourseDirectory.course_id = "IntroductionToDataScience"
...
#  raised. If True, `CellExecutionError` will be raised for any error that occurs
#  while executing the notebook. This overrides the ``allow_errors`` and
